...
<template>
  <div class="search-page">
    <section class="search-hero">
      ...
      <div v-if="topLiked.length" class="trending-posts">
        <p class="trend-caption">HOT RIGHT NOW</p>
